...
1. Simulates how a jumping spider views a scene across different **viewing angles**
2. Determines **viewing distance** based on where gaze intersects the ground plane
3. Generates images formed at the focusing planes associated with Tier I and Tier II of the retina
4. Estimates depth using a modified version of:
   - **FocalSplit**
   - **FocalTrack** (optional)
